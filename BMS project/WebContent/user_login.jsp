...
<spr:form action="prep_user_index.htm" method="post" commandName="user" >
                    ...
                    <div class="row justify-content-center" style="height:fit-content;">
                        ...
                        <div class="col bg-dark " style="box-shadow: 0px 0px 10px 6px rgb(34, 32, 32);border-radius: 10px;opacity: 0.9;">
                            ...
                            <div class="row mt-4  justify-content-between ">
                                ...
                                <div class="mr-2 ">
                                   <spr:input placeholder="Enter email" path="email"/>
				</div>
                             ...
                             <div class="row mt-4  justify-content-between ">
                                ...
                                <div class=" ml-2" style="text-decoration: underline;">Password</div>
                                <div class="mr-2 ">
                                   <spr:password placeholder="Enter password" path="password"/>
				</div>
                            ...
                            <div class="row mb-3 mt-4 justify-content-center ">
                                ...
                                <div class="col d-flex justify-content-between ">
                                    <div> <button class="btn btn-light btn-sm btn-outline-danger "><a href="forgot_password.html" >forgot password</a></button></div>
                                    <div> <button type="submit" value="Login" class="btn btn-light btn-sm btn-outline-danger ">Submit</button></div>
                                </div>
                         ...
                         <div class="row  mt-1 p-2 " style="background-color:;border-radius: 10px">
                         			<font color="orange" ><spr:errors path="email" ></spr:errors></font><br>
                         		
                         </div>
                         <div class="row  p-2 " style="background-color:black ;border-radius: 10px">
