      ...
      <spr:form action="user_list_search_1.htm" method="get" commandName="book" >
        ...
        <div class="row mt-4 mb-4 justify-content-center">
            ...
            <div class="col-4 " style="border: 4px double;box-shadow: 7px 7px 0px 3px grey;">
                ...
                <div class="row justify-content-between mt-2 mx-2"><span style="text-decoration: underline;">Author Name</span> <span><spr:input placeholder="Enter Book Author" path="bookAuthor"/></span></div>
