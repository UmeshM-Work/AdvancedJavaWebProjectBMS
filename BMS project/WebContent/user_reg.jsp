    ...
    <spr:form action="prep_user_log.htm" method="post" commandName="user">
        <div class="container-fluid">
            ...
            <div class="row justify-content-center mt-5">
                ...
                <div class="col-10 col-md-2 ml-3">
                    ...
                    <div class="row justify-content-center" style="height:fit-content;">
                        ...
                        <div class="col bg-dark " style="box-shadow: 0px 0px 10px 6px rgb(34, 32, 32);border-radius: 10px;opacity: 0.9;">
                            ...
                            <div  class="row mt-4 justify-content-between text-warning" stylec>


                                <div class="ml-2">
                                    <spr:errors path="name"></spr:errors>
                                </div>


                            </div>
                            <div class="row mt-4 justify-content-between  text-warning">


                                <div class="ml-2">
                                    <spr:errors path="mobile"></spr:errors>
                                </div>


                            </div>
                            <div class="row mt-5 justify-content-between  text-danger">
                            ...
                            <div class="row mt-4 mb-2 justify-content-between text-danger">
