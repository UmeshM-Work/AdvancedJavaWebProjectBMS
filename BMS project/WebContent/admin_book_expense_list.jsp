...
<body style="background-color: rgb(209, 209, 209);">
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center mb-5" style="margin-top:10vh;" >
		...
		%>  
               <tr>
                    ...
                    <td><%=exp.getBookQty()%></td>
                    <td><button class="btn-warning btn btn-sm "><a href="book_delete.htm?bookId=<%=exp.getBookId()%>">Delete</a></button></td>
                    <td><button class="btn-success btn btn-sm "><a href="admin_book_update_list.htm?bookId=<%=exp.getBookId() %>">Update</a></button></td>
                </tr>
                  <% } %>
